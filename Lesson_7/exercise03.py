...
class Cell:
    ...
    def __add__(self, other):
        return f'Сумма ячеек двух клеток равна: {self.quantity + other.quantity}'

    def __sub__(self, other):
        sub = self.quantity - other.quantity
        return f'Количество ячеек после вычитания клеток равна: {sub}' if sub > 0 else 'Клетка исчезла :('
